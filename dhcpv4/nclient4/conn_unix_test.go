...
func TestDHCPClientFilter(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{"more fragments", tweak(6, 0x2000), false},
		{"fragment offset", tweak(6, 0x0001), false},
		{"more fragments and offset", tweak(6, 0x2001), false},
		{"dont fragment", tweak(6, 0x4000), true},
		{"reserved bit is outside the mask", tweak(6, 0x8000), true},
